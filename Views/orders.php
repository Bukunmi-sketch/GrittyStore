      ...
      <div class="middle">
        <?php if ($statement->rowCount() > 0) : ?>
          ...
          <div class="follow-unfollow">          
            <button type="submit" class="markbtn" ><a href="cpdf.php" style="text-decoration: none; color :white;"> Export to pdf </a> </button>  
            <button type="submit" class="approvebtn" ><a href="excel.php " style="text-decoration: none; color :white;"> Export to Excel Sheet </a> </button>     
          </div>
